            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('template')}}/dist/img/alby.jpeg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Alby Shabira</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('template')}}/dist/img/alby.jpeg" class="img-circle" alt="User Image">
                    <p>
